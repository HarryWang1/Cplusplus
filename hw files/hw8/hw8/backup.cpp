...
//*/
//
//Polynomial::Node::Node(int data = 0, Node* prev = nullptr, Node* next = nullptr) : data(data), prev(prev), next(next) {}
//
//// accessors    
//int Polynomial::Node::getData() { return data; }
//Node* Polynomial::Node::getNext() { return next; }
//Node* Polynomial::Node::getPrev() { return prev; }
//// mutators
//void Polynomial::Node::setData(int data) { this->data = data; }
//void Polynomial::Node::setNext(Node* next) { this->next = next; }
//void Polynomial::Node::setPrev(Node* prev) { this->prev = prev; }
//
///*
//===============
//POLYNOMIAL
